...
@section('content')
  <section id="page-drop" class="glass rounded-2xl p-6 shadow-md mb-8">
    <h2 class="text-lg font-semibold mb-3">Drop Entry</h2>

    <form action="{{ route('vehicle.drop.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4" id="dropForm">
    @csrf
  ...
  <script>
    ...
    dropzone.addEventListener('drop', (e) => { e.preventDefault(); dropzone.classList.remove('border-blue-400','bg-blue-50'); handleFiles(Array.from(e.dataTransfer.files)); });
